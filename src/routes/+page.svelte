<script lang="ts">
  ...
  import type Quote from '$lib/interfaces/quote.interface'
...
>
  <div class="flex flex-col gap-6 max-w-sm items-center sm:items-start">
    <h3 class="italic text-2xl font-cormorant font-medium">
